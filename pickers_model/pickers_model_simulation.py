...
import pickers_model.probabilistic_movement as pmove 

from pickers_model.robot_runner import RobotRunner
from pickers_model.robot_schedule import RobotAssignment 
from pickers_model.picking_agent import PickingAgent,PickerType,time_within_range
from pickers_model.picking_agent_deterministic import PDeterministic
from pickers_model.picking_agent_waiting1 import PWaiting1
from pickers_model.picking_agent_waiting2 import PWaiting2
from pickers_model.status import Status,RobotStatus

            
class PickersModelSimulation( PickersModel ):
    """A model with some number of agents."""

    def __init__(self, field_map, N, picker_type = PickerType.WAITING1, step_size = 3.0 ):
        super().__init__(self, field_map, N, picker_type = PickerType.RANDOM, picker_data = "", step_size = 3.0 )
        ...
        if self.spacetype == sf.SpaceType.GRID2D:
