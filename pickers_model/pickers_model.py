...
class PickersModel(mesa.Model):
    ...
    def find_pickers_considered_TimeInPolytunnel( self ):
        ...
        for p in self.pickers:
            print( p.picker_id, p.status_state, '\t p.status_state in states_that_can_call', p.status_state in states_that_can_call, '\t p.made_at_least_one_call ', p.made_at_least_one_call, '\t p.fruit_in_basket ', p.fruit_in_basket )
