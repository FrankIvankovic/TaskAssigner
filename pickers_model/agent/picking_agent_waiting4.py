...
class PWaiting4( PickingAgent ):

    def __init__(self, unique_id, model, picker_id = "", patience = 0.0, max_waiting_time = 180.0 ):
        super().__init__( unique_id, model, picker_id, picker_type = PickerType.WAITING4  )
        ...
        self.patience_model = PatienceTime( patience, max_waiting_time )
